...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, initialTab = 'signIn' }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white dark:bg-dark-card rounded-xl shadow-xl p-8 w-full max-w-md relative animate-slide-up">
        <button
          onClick={onClose}
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-dark-bg dark:text-white"
        ...
        <div className="mt-6">
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center">
              <span className="px-2 bg-white dark:bg-dark-card text-gray-500 dark:text-gray-400 text-sm">
          ...
          <div className="flex space-x-3">
            <button className="flex-1 py-2 px-3 border border-gray-300 dark:border-gray-600 rounded-lg flex justify-center items-center gap-2 hover:bg-gray-50 dark:hover:bg-dark-hover transition-colors">
            ...
            <button className="flex-1 py-2 px-3 border border-gray-300 dark:border-gray-600 rounded-lg flex justify-center items-center gap-2 hover:bg-gray-50 dark:hover:bg-dark-hover transition-colors">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300">SSO</span>
            </button>
          </div>
        </div>
