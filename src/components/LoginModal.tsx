      ...
      <div className="bg-white dark:bg-dark-card rounded-xl shadow-xl p-8 w-full max-w-md relative animate-slide-up">
        ...
        <div className="mt-6">
          ...
          <button 
            ...
            className="w-full py-2 px-3 border border-gray-300 dark:border-gray-600 rounded-lg flex justify-center items-center gap-2 hover:bg-gray-50 dark:hover:bg-dark-hover transition-colors disabled:opacity-50"
          >
